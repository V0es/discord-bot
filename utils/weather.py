...
def get_suntime_status(city: str) -> str:
    ...
    # 'срезаем' словарь с данными о погоде; берём оттуда пары с координатами и создаём из них новый словарь
    coords = dict([val for val in vals.items() if val[0] == 'lon' or val[0] == 'lat'])
